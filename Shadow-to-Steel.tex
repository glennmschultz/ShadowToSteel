...
The first forge, I have known the fire of the forge since childhood; I suffered from severe asthma. Each day was the same: some days were manageable, others a struggle.  But the nights were different.  I would wake in the late hours gasping for air, chest tight, lungs constricted.  My mother would come to help me.  Some nights I would pass out from lack of oxygen. Other nights I would collapse from exhaustion simply trying to breathe.
...
He was right.  Even then, without knowing the name for it, I was already walking through the first forge.  The same enemy who would later attack my cartilage,  my relations,  and my peace was already testing me in the quiet hours of childhood.  He could not break me then, and he would not break me later.  I had resolved myself to overcome my affliction, I began running; eventually working myself up to about a 6-1/2 minute mile.  I continued running participating in mini-marathons, and running marathon distance on my own, I also started weight training. 

\begin{tcolorbox}[
  colback=gray!8,           % very light grey background
  colframe=gray!40,         % subtle border
  coltitle=black,           % title text in black (as requested)
  title=Corinthians 1 13:11 "Charity Poem",
  fonttitle=\bfseries,
  boxrule=0.8pt,
  arc=4pt,                  % rounded corners
  left=12pt, right=12pt,
...
When I was a child,
I used to talk like a child, and reason like a child.
However, when I became a man, I put aside all childish ways.
\end{tcolorbox}

I would often pray to the Lord, why this affliction, why me?  Always, to no answer, because the prayer was not correct - a prayer of a child.  Rather, it is better not to question but to ask for help to overcome as the Lord sees fit.  Overtime, through fortitude and determination I got stronger.  I convinced myself that the Lord was an observer and not a participant in my life.  I drifted from the Church and came to despise any weakness in myself - weakness was something to remedied at all costs.  I had no charity for myself.


[Isaiah 48:10, Malachi 3:2–3, etc.]
