...
The Malachi 3:2-3 is not just poetic language.  Rather, it reflects the mechanics of how God forms a man.   The fire does not destroy the silver -- it burns away the dross so that what remains is pure.  The furnace does not consume the gold -- it separates the impurities so the metal can be shaped and used.
